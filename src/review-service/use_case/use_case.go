...
func (orderUseCase *OrderUseCase) GetOrderById(ctx context.Context, id *pb.ById) (result *pb.OrderResponse, err error) {
	...
	if err != nil {
		...
		result = &pb.OrderResponse{
			...
			Message: "review-service DetailOrder is failed, begin fail, " + err.Error(),
			Data:    nil,
		}
	...
	if err != nil {
		...
		result = &pb.OrderResponse{
			...
			Message: "review-service DetailOrder is failed, GetOrderProducts fail, " + err.Error(),
			Data:    nil,
		}
		return result, rollback
	}
	...
	if orderFound == nil {
		...
		result = &pb.OrderResponse{
			Code:    int64(codes.Canceled),
			Message: "review-service, DetailOrder is failed, order is not found by id, " + id.Id,
			Data:    nil,
		}
	...
	result = &pb.OrderResponse{
		Code:    int64(codes.OK),
		Message: "review-service, DetailOrder is succeed.",
		Data:    orderFound,
	}
...
func (orderUseCase *OrderUseCase) ListOrders(context.Context, *pb.Empty) (result *pb.OrderResponseRepeated, err error) {
	...
	if err != nil {
		...
		result = &pb.OrderResponseRepeated{
			Code:    int64(codes.Internal),
			Message: "review-service orderUseCase ListOrder is failed, begin fail, " + err.Error(),
			Data:    nil,
		}
	...
	if err != nil {
		...
		result = &pb.OrderResponseRepeated{
			Code:    int64(codes.Canceled),
			Message: "review-service orderUseCase ListOrder is failed, query to db  fail, " + err.Error(),
			Data:    nil,
		}
		return result, rollback
	}
...
func (orderUseCase *OrderUseCase) Order(ctx context.Context, request *pb.CreateOrderRequest) (result *pb.OrderResponse, err error) {
	...
	if err != nil {
		...
		result = &pb.OrderResponse{
			Code:    int64(codes.Internal),
			Message: "review-service orderUseCase Order is failed, begin fail, " + err.Error(),
			Data:    nil,
		}
	...
	for i, products := range request.Products {
		...
		if err != nil {
			...
			result = &pb.OrderResponse{
				Code:    int64(codes.Canceled),
				Message: "review-service orderUseCase Order is failed, getProduct fail, " + err.Error(),
				Data:    nil,
			}
			return result, rollback
		}
		if getProduct.Data == nil {
			...
			result = &pb.OrderResponse{
				Code:    int64(codes.Canceled),
				Message: "review-service orderUseCase Order is failed, " + getProduct.Message,
				Data:    nil,
			}
			return result, rollback
		}
		if products.Qty > getProduct.Data.Stock {
			...
			result = &pb.OrderResponse{
				Code:    int64(codes.Canceled),
				Message: "review-service orderUseCase Order is failed, product out of stock.",
				Data:    nil,
			}
			return result, rollback
		}
	...
	if err != nil {
		...
		result = &pb.OrderResponse{
			Code:    int64(codes.Canceled),
			Message: "review-service orderUseCase Order is failed, " + err.Error(),
			Data:    nil,
		}
	...
	if getUser.Data == nil {
		...
		result = &pb.OrderResponse{
			Code:    int64(codes.Canceled),
			Message: "review-service orderUseCase Order is failed, GetUser fail, " + getUser.Message,
			Data:    nil,
		}
		return result, rollback
	}
	...
	if request.TotalPaid < int64(totalOrderPrice) {
		...
		result = &pb.OrderResponse{
			Code:    int64(codes.Canceled),
			Message: "review-service OrderUseCase is failed, oorder fail,  total paid is not enough, total paid	 required " + string(strconv.FormatInt(int64(totalOrderPrice), 10)),
			Data:    nil,
		}
	...
	if err != nil {
		...
		result = &pb.OrderResponse{
			Code:    int64(codes.Canceled),
			Message: "review-service OrderUseCase is failed, order  fail,  query to db fail, " + err.Error(),
			Data:    nil,
		}
