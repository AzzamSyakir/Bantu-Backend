...
func (productUseCase *ProductUseCase) GetProductById(ctx context.Context, id *pb.ById) (result *pb.ProductResponse, err error) {
	...
	if err != nil {
		...
		result = &pb.ProductResponse{
			...
			Message: "transaction-service UseCase, DetailProduct, begin failed, " + err.Error(),
			Data:    nil,
		}
	...
	if err != nil {
		...
		result = &pb.ProductResponse{
			...
			Message: "transaction-service UseCase, DetailProduct is failed, GetProduct failed, " + err.Error(),
			Data:    nil,
		}
		return result, rollback
	}
	if productFound == nil {
		...
		result = &pb.ProductResponse{
			Code:    int64(codes.Canceled),
			Message: "transaction-service UseCase, DetailProduct is failed, product is not found by id" + id.Id,
			Data:    nil,
		}
		return result, rollback
	}
	...
	result = &pb.ProductResponse{
		Code:    int64(codes.OK),
		Message: "transaction-service UseCase, DetailProduct is succeed.",
		Data:    productFound,
	}
...
func (productUseCase *ProductUseCase) UpdateProduct(ctx context.Context, request *pb.UpdateProductRequest) (result *pb.ProductResponse, err error) {
	...
	if err != nil {
		...
		result = &pb.ProductResponse{
			Code:    int64(codes.Internal),
			Message: "transaction-service UseCase, UpdateProduct fail begin is failed," + err.Error(),
			Data:    nil,
		}
		return result, rollback
	}
	...
	if err != nil {
		...
		result = &pb.ProductResponse{
			Code:    int64(codes.Canceled),
			Message: "transaction-service UseCase Update Product is failed, product is not found by id" + request.Id,
			Data:    nil,
		}
		return result, rollback
	}
	...
	if err != nil {
		...
		result = &pb.ProductResponse{
			Code:    int64(codes.Canceled),
			Message: "transaction-service UseCase, Query to db fail, " + err.Error(),
			Data:    nil,
		}
		return result, rollback
	}
	...
	result = &pb.ProductResponse{
		Code:    int64(codes.OK),
		Message: "transaction-service UseCase Update Product is succes.",
		Data:    patchedProduct,
	}
	return result, commit
}
...
func (productUseCase *ProductUseCase) DeleteProduct(ctx context.Context, id *pb.ById) (result *pb.ProductResponse, err error) {
	...
	if err != nil {
		...
		result = &pb.ProductResponse{
			Code:    int64(codes.Internal),
			Message: "transaction-service UseCase, DeleteProduct is failed, " + err.Error(),
			Data:    nil,
		}
		return result, rollback
	}
	...
	if deletedproductErr != nil {
		...
		result = &pb.ProductResponse{
			Code:    int64(codes.Canceled),
			Message: "transaction-service UseCase, DeleteProduct is failed, " + deletedproductErr.Error(),
			Data:    nil,
		}
		return result, rollback
	}
	if deletedproduct == nil {
		...
		result = &pb.ProductResponse{
			Code:    int64(codes.Canceled),
			Message: "transaction-service UseCase, DeleteProduct is failed, product is not deleted by id, " + id.Id,
			Data:    nil,
		}
		return result, rollback
	}
	...
	result = &pb.ProductResponse{
		Code:    int64(codes.OK),
		Message: "transaction-service UseCase DeleteProduct is succeed.",
		Data:    deletedproduct,
	}
	return result, rollback
}
...
func (productUseCase *ProductUseCase) ListProducts(context.Context, *pb.Empty) (result *pb.ProductResponseRepeated, err error) {
	...
	if fetchproductErr != nil {
		rollback := begin.Rollback()
		errorMessage := fmt.Sprintf("transaction-service UseCase, ListProduct is failed, Getproduct failed : %s", fetchproductErr)
		result = &pb.ProductResponseRepeated{
			Code:    int64(codes.Canceled),
			Message: errorMessage,
			Data:    nil,
	...
	if fetchproduct.Data == nil {
		...
		result = &pb.ProductResponseRepeated{
			Code:    int64(codes.Canceled),
			Message: "transaction-service UseCase, ListProduct is failed, data product is empty ",
			Data:    nil,
		}
		return result, rollback
	}
	...
	result = &pb.ProductResponseRepeated{
		Code:    int64(codes.OK),
		Message: "transaction-service UseCase, ListProduct is succeed.",
